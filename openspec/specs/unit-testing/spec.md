...
Defines requirements for the Jest unit test suite covering pure helper functions, coverage reporting, and exclusion of generated artifacts from version control.
