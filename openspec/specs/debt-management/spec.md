# Capability: Debt Management

## Purpose

Allows users to track debts owed to creditors. Debts are grouped by source and displayed in a dedicated Debts view with aggregated balances and progress indicators.
