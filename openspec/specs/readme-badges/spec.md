...
Defines requirements for displaying CI status, test coverage, and Conventional Commits badges in the README, grouped prominently near the top of the document.
