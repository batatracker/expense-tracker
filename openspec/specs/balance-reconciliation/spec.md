...
Provides balance reconciliation functionality within the Income view, allowing users to record signed adjustment entries that correct the tracked balance to match real cash on hand.
